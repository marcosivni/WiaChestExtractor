...
**This repository contains data and metadata to reproduce the [CBIR feature extraction stage](https://github.com/marcosivni/webhigiia) reported in the manuscript _Enhancing COVID-19 and ILD diagnoses with Content-based Image Retrieval: An experimental study_, submitted to the Journal of Digital Imaging.**
